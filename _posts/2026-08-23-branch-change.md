...
1. **Eligibility:** You must have earned all specified credits in the Autumn Semester, not failed in any subject, and not been penalized for indiscipline. Students from B.Arch and B.Des programs are not eligible.
2. **Available Seats:** The change of branch is strictly against the number of vacancies or 10% of the sanctioned strength of the branch, whichever is higher.
3. **Branch Strength Constraint:** The resulting strength of the branch from which the transfer is made cannot fall by more than 25% of its existing strength.
4. **Tie-Breaker:** Change of branch is allowed strictly on the basis of SGPA. If the SGPA of more than one student is equal, their JEE (Advanced) ranks will be used as a tie-breaker.

> **Note**: The above points are a summary, not an exhaustive list. These are based on last year's policy and the institute holds the right to change it. You can reference the complete list of rules from last year's policy here: [https://channeli.in/noticeboard/notice/18375](https://channeli.in/noticeboard/notice/18375).
...
As mentioned earlier, the rules for this procedure have been considerably relaxed, but the entry into the “much coveted” circuit branches(CSE, DSAI, BSMSMA, ECE, and EE) remains an uphill task. The cutoff SGPA for the 2025-26 batch was as follows:
...
In case of ties in SGPA, official ties breaking rules for last year can be found at: [https://channeli.in/noticeboard/notice/18375](https://channeli.in/noticeboard/notice/18375).
